...
const presente = "garrafa especial";
const mensagem = "amor eternizado em cada gole";

function testPresente(presente, mensagem) {
 const esperado = "emoção verdadeira";
 const resultado = presente && mensagem ? "emoção verdadeira" : "sem efeito";

 console.assert(resultado === esperado, "Teste aprovado com sucesso!");
 return `Teste concluído: ${resultado}`;
}

console.log(testPresente(presente, mensagem));